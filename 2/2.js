...
exports.matches = exports.translateMyPlays = exports.Play = void 0;
const input2 = `C Z
C Z
C Y
C Z
...
const getScoreOfOutcome = (match) => {
    const matchTranslated = [match[0], (0, exports.translateMyPlays)(match[1])];
    switch (true) {
...
exports.translateMyPlays = translateMyPlays;
exports.matches = input2.split('\n').map(match => match.split(' '));
const allMatchesScores = exports.matches.map(match => getTotalScoreOfMatch(match));
